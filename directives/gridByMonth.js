        ...
        return {
            ...
            controller: function ($scope) {
                ...
                this.refresh = function () {
                    budgetMgr.getBudget(gridCtrl.params).then(function (response) {
            ...
            link: function (scope, elem, attrs, fCtrl) {
                scope.gridCtrl.renderGrid = function (data) {
                    var grid = document.querySelector('.gridByMonth');
                    if (grid.children[0]) {
                ...
                scope.$watch(function () { return scope.gridCtrl.budgetdata; }, function (newVal, oldVal) {
